...
- **[CoinGecko](https://github.com/msanlisavas/CoinGecko)** — .NET stack for the CoinGecko API. Four packages:
  - **[CoinGecko.Api](https://www.nuget.org/packages/CoinGecko.Api)** — strongly typed, AOT-safe client for the REST API (core + onchain). [![NuGet](https://img.shields.io/nuget/v/CoinGecko.Api?logo=nuget&label=nuget&color=004880)](https://www.nuget.org/packages/CoinGecko.Api) [![Downloads](https://img.shields.io/nuget/dt/CoinGecko.Api?logo=nuget&label=downloads&color=004880)](https://www.nuget.org/packages/CoinGecko.Api)
