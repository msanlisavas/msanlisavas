...
- **[CoinGecko](https://github.com/msanlisavas/CoinGecko)** — .NET wrapper for the CoinGecko API, with WebSockets, AI
  ...
  olor=004880&v=1)](https://www.nuget.org/packages/CoinGecko.Api) [![Downloads](https://img.shields.io/nuget/dt/CoinGeck
  o.Api?logo=nuget&label=downloads&color=004880&v=1)](https://www.nuget.org/packages/CoinGecko.Api)
  ### Stack
